...
$moduleName = "SRAM_".$readPorts."R".$temp.$writePorts."W";
...
Purpose:     Verilog model for a $readPorts read-ported$temp, $writePorts
             write-ported SRAM
Created:     Script $scriptName version $version
