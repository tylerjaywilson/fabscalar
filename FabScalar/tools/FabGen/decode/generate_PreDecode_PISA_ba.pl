...
#
# Purpose: This script creates PreDecode_PISA.v file for Block Ahead design.
################################################################################
...
# Create module name
$outputFileName = "PreDecode_PISA.v";
$moduleName = "PreDecode_PISA";

# Warning: -m option not working right now
print `cat PreDecode_PISA_ba.v`;
