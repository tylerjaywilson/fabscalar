...
begin
  ...
  if(fabScalar.activeList.commitCount > 1000000)
  begin
...
begin:COMMIT
 ...
 result[0]      = {reg_part3, reg_part2, reg_part1};
 ...
 result[1]      = {reg_part3, reg_part2, reg_part1};
 ...
 result[2]      = {reg_part3, reg_part2, reg_part1};
 ...
 result[3]      = {reg_part3, reg_part2, reg_part1};
...
begin:HANDLE_EXCEPTION
 ...
 begin
	$display("CYCLE:%d Exception is High\n",sim_count);
        for(j=0;j<`SIZE_RMT;j=j+1)
        begin
                {reg_part3, reg_part2, reg_part1}  = LOGICAL_REG[j];
