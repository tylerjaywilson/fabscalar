...
begin
  ...
  loadCnt     = (inst6Load+inst5Load+inst4Load+inst3Load+inst2Load+inst1Load+inst0Load);	
  ...
  storeCnt    = (inst6Store+inst5Store+inst4Store+inst3Store+inst2Store+inst1Store+inst0Store);	
end
