...
#
# Purpose: This script creates Verilog file for AMT.
################################################################################
...
{
	print "\n";
	print "Usage: perl $scriptName -r <retire_width> -d <dispatch_width> [-m] [-v] [-h]\n";
	print "\t-m: Add header\n";
...
if($retireWidth != 4)
{
	die "AMT not implemented for retires widths other than 4.\n";
}
...
************************************************************************************/
SRAM_${dispatchWidth}R4W_AMT #(`SIZE_RMT,`SIZE_RMT_LOG,`SIZE_PHYSICAL_LOG)
        AMT ( .clk(clk),
              .reset(reset),
              .addr0_i(addr0),
              .addr1_i(addr1),
