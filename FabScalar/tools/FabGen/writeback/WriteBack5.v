...
module WriteBack ( input clk,
		   input reset,
			  ...
			  `SIZE_LSQ_LOG+`CHECKPOINTS_LOG+`SIZE_CTI_LOG+`SIZE_PC:0] exePacket4_i,
...
*/
 ...
 assign bypassValid4_o = lsuPacketValid0 & lsuPacket0Flags[4];
 ...
 assign bypassPacket4_o = {lsuPacket0[`SIZE_PHYSICAL_LOG+`SIZE_ACTIVELIST_LOG+`SIZE_ISSUEQ_LOG-1:
 ...
 assign ctrlVerified        = exePacketValid3;
 assign ctrlConditional	    = exePacket3Flags[5];
 assign ctrlMispredict      = exePacket3Flags[0];
 assign ctrlSMTid           = exePacket3[`CHECKPOINTS_LOG+`SIZE_CTI_LOG+`SIZE_PC:`SIZE_CTI_LOG+`SIZE_PC+1];

 assign ctrlTargetAddr      = exePacket3[`SIZE_PC:1];
 assign ctrlBrDirection     = exePacket3[0];
 assign ctrlCtiQueueIndex   = exePacket3[`SIZE_CTI_LOG+`SIZE_PC:`SIZE_PC+1];
...
always @(*)
 ...
 assign writebkValid4_o     = lsuPacketValid0 & ~invalidateLsuPacket; 
 ...
 assign ctrlFU4_o     = {lsuPacket0[`SIZE_ACTIVELIST_LOG+`SIZE_ISSUEQ_LOG-1:`SIZE_ISSUEQ_LOG],
