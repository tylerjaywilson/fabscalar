...
int readOperand_calltf(char *user_data)
{
  SS_INST_TYPE inst;
...
void readOperand_register() {
  s_vpi_systf_data task_data_s;

  task_data_s.type      = vpiSysFunc;
  //task_data_s.sysfunctype = vpiSysFuncSized;
  task_data_s.tfname    = "$read_operand";
  task_data_s.calltf    = readOperand_calltf;
